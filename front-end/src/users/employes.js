            ...
            listaEmpleados = result
                result.forEach(element => {
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 border-b dark:bg-gray-900">
                        <th scope="row" class="px-4 py-2 text-gray-900 whitespace-nowrap dark:text-gray-50">T0${element.id}</th>
                        ...
                        <td class="px-4 py-2 -ml-5 flex space-x-2">
                            <i class="fa-solid fa-pen-circle text-green-600 dark:text-green-400 text-3xl cursor-pointer" onclick="editarEmpleado('modalEmploye', ${element.id})"></i>
                            <i class="fa-solid fa-circle-trash text-red-600 dark:text-red-400 text-3xl cursor-pointer" onclick="confirmarEliminacionE('deleteModalE',${element.id})"></i>
                        </td>
                    </tr>
                    `
                });
