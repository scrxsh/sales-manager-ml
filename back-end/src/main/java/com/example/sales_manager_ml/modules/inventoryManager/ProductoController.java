...
public class ProductoController {
    ...
    public ResponseEntity<List<VentaModel>> obtenerListaVentasProducto(@PathVariable Long id_producto){
        List<VentaModel> ventas = productoService.obtenerProductoVendido(id_producto);
